    ...
    return `
      <div class="auth-container">
        <div class="auth-card">
          ...
          <!-- Use x-form dynamic form -->
          <x-form data-id="login-form" class="auth-form">
            <div 
              data-field="email" 
          ...
          <div class="auth-footer">
            <p class="footer-text">
              ...
              <a href="signup.html" class="link-text link-primary">Sign up</a>
            </p>
          </div>
        </div>
    `;
